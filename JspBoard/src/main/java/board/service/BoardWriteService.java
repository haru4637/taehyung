...
//		if(board_title==null|| board_title.equals(board_title.equals("")|| board_content==null|| board_content.equals("") ||
//				board_content==null || board_writer==null)) {//여기서 null체크를 해야한다
//			
//		} 필요하다면 입력값에 대한 검사를 진행한다
		...
		//return "redirect::"+request.getContextPath() +"/"; // 아래방식으로 한 후 ApplicationServlet에서 처리해도 된다
		return "redirect::/";
	}
