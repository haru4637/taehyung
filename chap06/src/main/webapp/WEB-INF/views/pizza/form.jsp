...
<body>
   ...
   <div>
      <div>
         <span>피자1</span> <br>
         M 30,000원<input type="radio" name="price1" form="form1">
         L 35,900원<input type="radio" name="price1" form="form1"><br>
   ...
   <ul>
   		...
   		if(cart==null){
   			...
   			for(PizzaOrder order : (List<PizzaOrder>)cart){//toString메서드의 결과값
   				out.print(order);
   			}
   		}
   		%>
