...
<body>
	...
	<ul>
		...
		<li>요청, 응답 객체를 그대로 다음 서블릿으로 전달하기 때문에 
			해당 요청에 실려있던 파라미터들도 그대로 전달된다</li>
	...
	<ul>
		<li>서블릿에서는 자바코드 작성이 편하고 .jsp파일에서는 HTML 코드 작성이 편하다</li>
		...
		<li>이것을 view(jsp)와 controller (.java)의 분리라고 한다</li>
		<li>forward를 사용하면 실제 view페이지의 위치가 노출되지 않는다 (과정을 클라이언트측에서는 모른다)</li>
	...
	<ul>
		...
		이전 요청에 보냈던 파라미터는 기본적으로는 남아있을 수 없다</li>
	</ul>
